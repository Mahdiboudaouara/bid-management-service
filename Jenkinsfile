pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'mahdiboudaouara/bid-management-service'
        PROJECT_NAME = 'bid-management-service'
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'github', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                        ...
                        sh "git remote set-url origin https://${USER}:${PASS}@github.com/Mahdiboudaouara/bid-management-service.git"
                        sh 'git add .'
